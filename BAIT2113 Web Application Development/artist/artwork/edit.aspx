...
<asp:Content ID="Content2" ContentPlaceHolderID="contentMain" runat="server">
    <div class="row">
        <form class="needs-validation col-4" novalidate runat="server">
            ...
            <hr class="mb-4">
            <asp:Button ID="BtnUpdate" class="btn btn-primary btn-lg btn-block" runat="server" Text="Update Post" OnClick="BtnUpate_Click" />
            <!-- Add remove button later, which would prompt a modal and let the user comfirm. -->
        </form>
