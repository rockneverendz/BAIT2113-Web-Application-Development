        ...
        <div class="row">
            <div class="col-4">
                <div class="mb-3">
                    ...
                    <asp:Label ID="lblEmail" CssClass="invalid-feedback d-block" Visible="false" Text="A title is required." runat="server"></asp:Label>
                </div>

                <div class="mb-3">
                    <label for="inputPassword">Password <span class="text-muted">(Optional)</span></label>
                ...
                <div class="mb-3">
                    ...
                    <asp:TextBox ID="inputRetypePassword" name="Password" type="password" class="form-control"
                        placeholder="Password" runat="server" required="true"></asp:TextBox>
                    <asp:Label ID="lblRetypePassword" CssClass="invalid-feedback d-block" Visible="false" Text="Please enter a valid price." runat="server"></asp:Label>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <asp:TextBox ID="inputOldPassword" name="Password" type="password" class="form-control"
                        placeholder="Password" runat="server" required="true"></asp:TextBox>
                    <asp:Label ID="lblOldPassword" CssClass="invalid-feedback d-block" Visible="false" Text="Please enter a valid price." runat="server"></asp:Label>
                </div>
